...
data_dir = f"/mnt/c/Users/bobst/Documents/University_of_British_Columbia/"\
                f"Physics/Mona_Berciu/Generalized_Green_function_cluster_expan"\
                f"sion/fin_T_hol"
...
year = f"22"
krange = ['0.000', '0.008', '0.017', '0.025', '0.033', '0.041', '0.050', '0.058', \
            '0.066', '0.074', '0.083', '0.091', '0.099', '0.107', '0.116', '0.124',\
            '0.132', '0.141', '0.149', '0.157']

results_dir = os.path.join(data_dir, f"lam_{lam}", f"om_{om}", f"t_{t}", aux,\
...
best_fit_pars, covmat = curve_fit(quadratic_band, kgrid, energy_k, \
                                                p0 = [0.5, energy_k[0]])
best_fit_pars_2point, covmat_2point = curve_fit(quadratic_band, kgrid, energy_k_2point, \
                                                p0 = [0.5, energy_k_2point[0]])
...
print(f"scipy fit: m_star / m_0 = {best_fit_pars[0] / 0.5041061511616247} (m_0 = 0.5041061511616247)")
print(f"two-p fit: m_star / m_0 = {best_fit_pars_2point[0] / 0.5041061511616247} (m_0 = 0.5041061511616247)")
