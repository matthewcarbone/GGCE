...
class TestLiteratureEFB:
    ...
    def test_EFB_figure5_k0(self, figure5_k0_ground_truth):
        ...
        assert np.allclose(results_dense, results_sparse, atol=1e-4)
        assert np.allclose(results_sparse, A_gt, atol=1e-4)
