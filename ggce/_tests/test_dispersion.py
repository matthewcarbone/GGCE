...
from ggce import Model, System, SparseSolver, DenseSolver, MassSolverMUMPS
...
def test_dispersion_finiteT(p):
    ...
    results = executor_sparse.dispersion(kgrid, w0, eta=eta, nmax=1000, \
    ...
    results = executor_dense.dispersion(kgrid, w0, eta=eta, nmax=1000, \
            eta_step_div=10, peak_routine="scipy", next_k_offset_factor=2)
    dispersion, lifetimes = process_dispersion(results)
